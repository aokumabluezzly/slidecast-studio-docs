...
PAGES: dict[str, tuple[str, str]] = {
    ...
    "manual": ("_source/manual.en.spec.json", "en/manual/index.html"),
    ...
    "ai-code-bgm-studio": ("_source/ai-code-bgm-studio.en.spec.json", "en/ai-code-bgm-studio/index.html"),
    "ai-code-movie-studio": ("_source/ai-code-movie-studio.en.spec.json", "en/ai-code-movie-studio/index.html"),
    ...
    "v40": ("_source/v40.en.spec.json", "en/updates/v40/index.html"),
